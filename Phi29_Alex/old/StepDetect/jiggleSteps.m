function [outInd, outVar] = jiggleSteps( inContour, inInd, inVar, window )
%Attempts to slightly move the already found steps in of inContour stored in inInd

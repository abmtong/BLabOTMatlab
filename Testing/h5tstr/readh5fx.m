...
%F-X
%lo freq
ext1 = h5read(infp, '/Distance/Distance 1');
ext2 = h5read(infp, '/Distance/Distance 2');
fx1l = h5read(infp, '/Force LF/Force 1x');
fy1l = h5read(infp, '/Force LF/Force 1y');
fx2l = h5read(infp, '/Force LF/Force 2x');
fy2l = h5read(infp, '/Force LF/Force 2y');

%hi freq
fx1 = h5read(infp, '/Force HF/Force 1x');
fy1 = h5read(infp, '/Force HF/Force 1y');
fx2 = h5read(infp, '/Force HF/Force 2x');
fy2 = h5read(infp, '/Force HF/Force 2y');

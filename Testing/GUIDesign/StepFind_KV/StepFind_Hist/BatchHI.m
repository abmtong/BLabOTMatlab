function [outInd, outMea, outTra, stepDist, firstP] = BatchHI(inContour, inYRes, inNoise, useP, maxIter, verbose)
...
for i = 1:maxIter
    ...
    if i == 1 || i == 2
        fprintf('[\n')
        %Do stepfinding
        %Computationally intensive enough to warrant parfor every time

/*
 * findStepHMMV1c_ccode_xiV2_emxutil.c
 *
 * Code generation for function 'findStepHMMV1c_ccode_xiV2_emxutil'
 *
 */
...
/* End of code generation (findStepHMMV1c_ccode_xiV2_emxutil.c) */

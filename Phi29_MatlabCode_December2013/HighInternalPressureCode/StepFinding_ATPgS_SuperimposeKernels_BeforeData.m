function [ClusterPeak KernelCurve]= StepFinding_ATPgS_SuperimposeKernels_BeforeData
    ...
    global analysisPath;
    [DataFile DataPath] = uigetfile([ [analysisPath filesep ] '*.mat'], 'Please select ***_ResultsKV_BeforeExtra_Valid files','MultiSelect', 'on');
    if ~iscell(DataFile)

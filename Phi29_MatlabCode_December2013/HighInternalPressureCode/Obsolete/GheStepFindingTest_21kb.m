...
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\MatlabCode\MatlabFilesGhe\MatlabGeneral\GheStepFindingCode\SampleDataHIP\PhageIndex21kb.txt';
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\21kb_031610N22.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\21kb_031610N27.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_031610N22.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_031110N19.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_031010N26.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_031010N24.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_031010N22.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_031010N16.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_031010N13.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030810N21.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030810N08.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030410N24.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030410N19.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030410N13.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030310N35.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030310N32.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030310N26.txt'; %do it one phage at a time
IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\21kb_030310N17.txt'; %do it one phage at a time
%IndexFile = 'C:\Documents and Settings\Phi29\Desktop\HIP_Analysis\21kb\Straight_030310N37.txt'; %do it one phage at a time
...
for n=1:length(phageDataInd)
    ...
    while r<=NRound && strcmp(LoopStatus,'continue') %continue until Nround is reached, or convergence is achieved
        ...
        ShortestDwell = 0.05; %set the shortest dwell to 50 msec

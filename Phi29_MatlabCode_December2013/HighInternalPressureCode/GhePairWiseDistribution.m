function [number, distance] = GhePairWiseDistribution(ContourData,HistogramBins)
...
%
% USE: [number, distance] = GhePairWiseDistribution(ContourData,HistogramBins)
%
% Gheorghe Chistol, 15 Sept 2010

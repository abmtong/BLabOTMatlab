function [Nmin DwellTimes]=MonteCarlo_Simulating5Subunits(Tatp_on,Tatp_off,Tadp_on,Tadp_off,Tatp_tight,AlphaT,AlphaD,AlphaTb,Nrounds)
...
for r=1:Nrounds
    ...
    while n<=ActiveSubunits 
        ...
        if n==1 %the first subunit: ADP-release and ATP-binding are special
            temp = MonteCarlo_ADP_Empty_ATP_TightATP(Tatp_off,AlphaT*Tatp_on,AlphaD*Tadp_off,Tadp_on,AlphaTb*Tatp_tight);
        elseif n==2

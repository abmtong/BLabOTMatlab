function [Nmin DwellTimes]=MonteCarlo_Simulating5Subunits(Tatp_on,Tatp_off,Tadp_on,Tadp_off,Tatp_tight,Tadps_off,Tatps_on,Nrounds)
...
for r=1:Nrounds
    ...
    while n<=ActiveSubunits 
        ...
        if n==1 %the first subunit: ADP-release and ATP-binding are special
            temp = MonteCarlo_ADP_Empty_ATP_TightATP(Tatp_off,Tatps_on,Tadps_off,Tadp_on,Tatps_tight);
        elseif n==2

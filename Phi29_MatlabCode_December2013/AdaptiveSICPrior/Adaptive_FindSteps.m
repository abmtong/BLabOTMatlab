function [DwellInd History]= Adaptive_FindSteps(Y,PenaltyFactor)
    ...
    [SIC DwellInd] = Adaptive_ComputeSIC(Y,StepInd,DwellInd,PenaltyFactor); %do this to update the DwellInd for the last time

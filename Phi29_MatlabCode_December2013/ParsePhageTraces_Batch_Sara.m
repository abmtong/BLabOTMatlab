function ParsePhageTraces_Batch_Sara()
...
DefaultParams = {'2500','760','578','1.25','0.6'}; % Ghe, Valid after 05/03/10
...
for f=1:length(RawFile)
    ...
    stepdata = ParsePhageTraces_ProcessOneFile_Sara(Files,Params);
    save([analysisPath filesep 'phage_sara_' RawFile{f}(1:end-4) '.mat'], 'stepdata'); %saves automagically, no need for extra mouse clicks

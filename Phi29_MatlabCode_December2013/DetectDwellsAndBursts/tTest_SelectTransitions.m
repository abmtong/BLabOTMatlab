function [transitions,fit] = tTest_SelectTransitions(data,sgn,param)
% Yann Chemla
...
% transitions.wid
% 
% data is simply the y-axis value vector
% param = [tTestThr WindowSize]
% sgn: the tTest significance vector
%
% USE: [transitions,fit] = tTest_SelectTransitions(data,sgn,param)

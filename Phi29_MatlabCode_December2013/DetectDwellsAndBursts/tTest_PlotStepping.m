function FigureHandle=tTest_PlotStepping(Data,RawContour,RawTime,Dwells)
...
FigureHandle=figure('Units','normalized','Position',[0.0059    0.0625    0.4883    0.8359],'PaperPosition',[0 0 4 10]); 
hold on;
set(gca,'Color',[1 1 1]);

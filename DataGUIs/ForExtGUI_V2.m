...
frcRange = uicontrol('Parent', pantop, 'Style', 'edit', 'Units', 'normalized', 'Position', [.25 0 .05 .5], 'String', '[1.5 35]');
...
datTable  = uitable  ('Parent', panlef,                  'Units', 'normalized', 'Position', [0 .35 1 .25], 'Data', zeros(8,1), 'RowName', {'Last' 'PL' 'SM' 'CL' 'OffX' 'OffF' 'Avg' 'PL' 'SM' 'CL' 'OffX' 'OffF'}, 'ColumnName', '');

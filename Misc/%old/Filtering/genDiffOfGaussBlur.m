function outDoG = genDiffOfGaussBlur( inWidth, inSD )
% Creates a normalized Difference of Gaussians blurring filter defined by its width and the SD of the gaussian
...
x = -width:1:width;
y = normpdf(x,0,inSD) - 0.44*normpdf(x,0,1.55*inSD);

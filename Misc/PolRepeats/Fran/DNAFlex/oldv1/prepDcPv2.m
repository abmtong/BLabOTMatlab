function out = prepDcPv2(nucseqs, maxn, seqperchunk)
...
%Creates struct + txt to send to DNAcycP
% Struct has fields: chr, gene, nnuc (nuc position within gene), rnaseq (RNAseq value)
% Turn the output txt with this struct into a file with prepDcPv2p2

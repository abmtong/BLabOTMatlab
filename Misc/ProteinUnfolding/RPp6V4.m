function [out, outraw] = RPp6V4(inst, dir)
...
if nargin < 2 || isempty(dir)
    %Just do both
    [o1, or1] = RPp6V4(inst,  1); %Make sure this is this file actually, not a prev ver.
    [o2, or2] = RPp6V4(inst, -1);
...
usexwlc = 1; %Use XWLC term in Fd/kT
verbose = 1;

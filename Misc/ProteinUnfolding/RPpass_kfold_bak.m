...
%                 ftfol = 1/k; 
        ...
        % Folding, -Fd/kT
        fitfcnf = @(x0,x, xxw, y) x0(1) - x * x0(2) .* xxw / kT;
        ...
        % Unfolding, +Fd/kT
        fitfcnu = @(x0,x, xxw, y) x0(1) + x * x0(2) .* xxw / kT;
...
%         plot(ffu, polyval(pfu, ffu), ':')
        ...
        ftlgn = { sprintf('F Fit, \\delta=%0.2fnm', -pff(1)*kT)...
            sprintf('U Fit, \\delta=%0.2fnm',  pfu(1)*kT) };

...
opts.pwlcc = 0.38*127; %Protein contour length, will be used as a set value
...
for i = 1:len
    ...
    dft = lsqcurvefit(fitfcn, xg, f(1:ri),x(1:ri), lb, ub);
    ...
    pft = lsqcurvefit(fitfcn2, xg2, f, x, lb2, ub2);

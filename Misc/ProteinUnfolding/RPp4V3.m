...
for i = 1:len
    ...
    %Filter
    yf = windowFilter(@median, yy, opts.reffil, 1);
    
    %Find first crossing...?
    ind = find(yf < tmp.xwlcft(7) * opts.pwlccmult , 1, 'first');

function out = RPpass_p2_xwlcV2(inst, inOpts)
...
for i = 1:len
    ...
    %Lets just divide by XWLC and then shift the top back down?
    con = tmp.conpro;
    con = con ./ XWLC(frc, opts.xwlcft(3), inf);
    con = con  *  XWLC( tmp.folfrc(2), opts.xwlcft(3), inf);

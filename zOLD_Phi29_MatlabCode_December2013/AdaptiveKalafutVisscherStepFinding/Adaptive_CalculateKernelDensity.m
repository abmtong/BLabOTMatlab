function [KernelGrid KernelValue] = Adaptive_CalculateKernelDensity(RawY,KernelFiltFact)
    ...
    %
    % USE: [KernelGrid KernelValue] = KV_CalculateCustomKernelDensity(RawY,KernelFiltFact)
    %
    ...
    for i=1:length(FaD.Y)
        ...
        KernelValue = Adaptive_CalculateKernelDensity_AddGausian(KernelGrid, KernelValue, FaD.Y(i), FaD.StErr(i)); 
    end

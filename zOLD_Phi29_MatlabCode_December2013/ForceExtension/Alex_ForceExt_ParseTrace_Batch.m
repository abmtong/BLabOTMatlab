function Alex_ForceExt_ParseTrace_Batch(fullFilePath)
...
% Gheorghe Chistol, 13 Feb 2012
    ...
    DefaultParams = {'2500','762','578','1.4','0.9'}; %Alex 091417
   ...
   % TrapYoffset   = Params(5);
    ...
    BatchFileName = strcat(BatchFile, BatchFileExt);
    ...
    for f = 1:length(RawFileName)
        ...
        [ContourData, CalibratedData, OffsetData] = ForceExt_ParseTrace_ProcessOneFile(FileNameAndPath,Params);

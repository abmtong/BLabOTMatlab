function Param = ParsePhageTraces_InputParamDialog(Title,Prompts,DefaultParams)
...
% "getnumbers.m". Pretty much identical to all the other
% '*_InputParamDialog.m' functions.
%
% USE: Param = GheParsePhageTraces_InputParamDialog(Title,Prompts,DefaultParams)
%

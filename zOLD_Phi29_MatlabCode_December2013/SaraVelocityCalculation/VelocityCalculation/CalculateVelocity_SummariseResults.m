function VelSummary = CalculateVelocity_SummariseResults()
% This function is used to organize and summarize the results for several phages. Please look over
% the parameters and make sure they are ok. Pay special attention to ForceBoundaries and
% TetherLengthBoundaries. Use the data preview generated by CalculateVelocity_AggregatePreview to
% get a general idea for the Cutoff parameters.
%
% Gheorghe Chistol, 14 Oct 2012

    ForceBoundaries        = [7 12];
    TetherLengthBoundaries = [500:2000:10000];

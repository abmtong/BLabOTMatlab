...
%
    ...
    ATP = [10 20 40 60 80 100 200 300 400 500 1000]; % This is the list of ATP conditions to titrate
    ...
    for t=1:length(ATP)  % this cycle goes through all the ATP conditions that are defined in the above vector
    ...
    Tatp_on = 1/(ATP_on*ATP(t)); %the loosely bind time is inversely proportional to ATP concentration
            ...
            [Nmin DwellTimes]=MonteCarlo_Simulating5Subunits(Tatp_on,Tatp_off,Tadp_on,Tadp_off,Tatp_tight,AlphaT,AlphaD,Nrounds); 

...
% Gheorghe Chistol, 25 feb 2013
    global analysisPath;
    [FileName FilePath] = uigetfile([ [analysisPath filesep 'BurstDurationAnalysis' filesep] 'BurstDur*.mat'], 'Please select the Burst Duration Results File','MultiSelect','on');

function data = MakeOffsetFiles_LoadRawFile(fsamp,RawFileName,RawFilePath)
...
Ind1 = linspace(1, L-7, N); %the index for Vay data %A: This seems inefficient when you could just use colon spacing?

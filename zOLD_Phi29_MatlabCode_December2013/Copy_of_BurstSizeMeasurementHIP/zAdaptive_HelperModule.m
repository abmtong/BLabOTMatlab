function [FinalDwells FinalDwellsValidated] =  Adaptive_HelperModule(RawT,RawY,RawF,PenaltyFactor,ContrastThr,MaxSeparation,AvgNum,Bandwidth,CurrentPhageName,CurrentPhageFile,CurrentFeedbackCycle,analysisPath,s)
% This function makes it easier to manage the operations required for step-finding in a particular
 ...
 %
    ...
    [ValidatedFragDwellInd KernelDensity] = Adaptive_ValidateDwells_FragDwellInd(RawT,RawY,FiltT,FiltY,FiltF,FragDwellInd,ContrastThr,MaxSeparation,AvgNum);
